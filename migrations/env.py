...
# Make the src/ directory importable so Alembic can
# import the banking_investigator package.
sys.path.insert(
    0,
...
# Importing the models above ensures that SQLAlchemy knows
# about all tables when Alembic performs autogeneration.
